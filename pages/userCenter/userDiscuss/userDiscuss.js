// pages/userCenter/userDiscuss/userDiscuss.js
...
Page({
  data: {
    ...
    nvabarData: {
      ...
      "navigationBarTitleText": "我的评论", //  导航栏标题文本
  ...
  loadData(page = this.data.initPage) {
    ...
    specialModel.getList('project', page)
      .then(({ data }) => {
        ...
        this.loadMoreView.loadMoreComplete({ curPage, pageCount: 2 })
      }).catch(err => {
